...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/yurichanuy/auto-ssh/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/yurichanuy/auto-ssh/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/yurichanuy/auto-ssh/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
